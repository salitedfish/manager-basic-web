<template>
    <div class="app-container">
        ...
        <select-business ref="selectRef" :orgId="queryParams.orgId" :orgType="queryParams.orgType" @ok="handleQuery" />
    </div>
</template>
...
function handleClose() {
    const obj = closeOjb[queryParams.orgType];
